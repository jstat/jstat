var vows = require( 'vows' ),
	...
	suite = vows.describe( 'jStat.geomean' );
...
suite.addBatch({
	'geomean' : {
		...
		'geomean matrix cols' : function( jStat ) {
			assert.deepEqual( jStat([[1,2],[3,4]]).geomean(), [1.7320508075688772,2.8284271247461903]);
		},
