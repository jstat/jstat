...
suite.addBatch({
  'percentiles': {
    ...
    'return basic percentile of score': function(jStat) {
      assert.deepEqual(jStat.percentileOfScore([1, 2, 3, 4, 5, 6],
                                       3), 0.5);
      assertAlmostEqual(jStat.percentileOfScore([1, 2, 3, 4, 5, 6],
                                       5), 0.83333333333333343, tol);
