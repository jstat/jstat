...
suite.addBatch({
  'gamma pdf': {
    ...
    'check pdf': function(jStat) {
      tol = 0.000001;
      assert.epsilon(tol, jStat.gamma.cdf(2, 1, 1), 0.1353352832);
      assert.epsilon(tol, jStat.gamma.cdf(5, 10, 2), 0.000431450369);
      assert.epsilon(tol, jStat.gamma.cdf(18, 22, 0.8), 0.1029848021);
      assert.epsilon(tol, jStat.gamma.cdf(-5, 7, 10), 0);
    },
